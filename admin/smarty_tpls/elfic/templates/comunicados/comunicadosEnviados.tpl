...
<div align="center" class="centermain">
  <div class="main">
   ...
   <tr bgcolor="{cycle values="#f4f4f4,#e8e8e8"}" 
      ...
      <td onclick="document.location.href='?com=comunicados&do=view&consecu={$com[row].consecu}'">{$com[row].consecu}</td>
      <td><input type="checkbox" name="cb[{$com[row].consecu}]" id="cb[{$com[row].consecu}]"></td>
      <td onclick="document.location.href='?com=comunicados&do=view&consecu={$com[row].consecu}'">{$com[row].asunto}</td>
      <td onclick="document.location.href='?com=comunicados&do=view&consecu={$com[row].consecu}'">{$com[row].fecha}</td>
      <td onclick="document.location.href='?com=comunicados&do=view&consecu={$com[row].consecu}'">{$com[row].fecvence}</td>
    </tr>
    {sectionelse}
    <tr>
