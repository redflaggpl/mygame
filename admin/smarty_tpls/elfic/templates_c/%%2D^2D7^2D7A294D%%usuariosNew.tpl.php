<?php /* Smarty version 2.6.26, created on 2012-05-29 14:31:10
         compiled from usuarios/usuariosNew.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'usuarios/usuariosNew.tpl', 93, false),)), $this); ?>
<?php echo '
         ...
         <form name="adminForm" id="adminForm" method="post" 
          ...
          <table width="100%" cellspacing="0" cellpadding="0">
           ...
           <tr>
              ...
              <td class="headlines">Tipo de Usuario</td>
              <td>
              	<select name="rol" id="rol" class="required" onchange="setCamposRolUsuario();">
					<option value="">--Seleccione--</option>
					<option value="-1">Superusuario</option>
		  			<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['roles']), $this);?>
