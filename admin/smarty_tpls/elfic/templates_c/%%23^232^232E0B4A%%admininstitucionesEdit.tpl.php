<?php /* Smarty version 2.6.26, created on 2012-06-28 10:52:42
         compiled from usuarios/admininstitucionesEdit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'usuarios/admininstitucionesEdit.tpl', 92, false),)), $this); ?>
<?php echo '
...
<table class="adminheading">
    <tr>
      <th class="usersnew">
	Edición de Administrador de Institución
      </th>
    </tr>
    </table>
      ...
      <table width="100%" class="adminform">
        <tr>
         ...
         <form name="adminForm" id="adminForm" method="post" 
               action="index2.php?com=usuarios&do=view_admininstitucion">
          <table width="100%" cellspacing="0" cellpadding="0">
            <tr>
              <th colspan="6">Datos del Admnistrador de Institución</th>
            </tr>
            <tr>
...
" />
              ...
              <input type="button" name="Cancelar" value="Cancelar" onClick="location.href='index2.php?com=usuarios&do=admin_institucion'"></td>
              <td></td>
              <td>&nbsp;</td>
            </tr>
          </table>
