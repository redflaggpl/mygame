<?php /* Smarty version 2.6.26, created on 2012-06-01 09:12:54
         compiled from instituciones/institucionesNew.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'instituciones/institucionesNew.tpl', 42, false),)), $this); ?>
<?php echo '
              ...
              <!--
                  <select name="rector_id" id="rector_id" class="required">
					<option value="">--Rector--</option>
		  			<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['usuarios']), $this);?>
