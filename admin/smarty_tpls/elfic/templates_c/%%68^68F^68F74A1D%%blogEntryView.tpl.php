<?php /* Smarty version 2.6.26, created on 2011-01-06 16:27:09
         compiled from blogEntryView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'blogEntryView.tpl', 52, false),)), $this); ?>
<?php echo '
...
&do=updateentryblog">
          		<table width="400" cellspacing="0" cellpadding="0" class="adminlist">
	    			<tr>
	    				<th colspan="2">Edición de Blog</th>
	    			</tr>
	    			<tr>
...
"/></td>
	    		 ...
	    		 <tr>
			            <td colspan="4">
			            <input type="hidden" name="id_unidades_turisticas" id="id_unidades_turisticas" value="<?php echo $this->_tpl_vars['id_unidades_turisticas']; ?>
"></input>
			            <input type="hidden" name="utid" id="utid" value="<?php echo $this->_tpl_vars['id_unidades_turisticas']; ?>
"></input>
...
&do=view&utid=<?php echo $this->_tpl_vars['id_unidades_turisticas']; ?>
'">
			            </td>
	    			</tr>
	    		</table>
    ...
    <td width="49%" valign="top">
	  	<table class="adminlist">
	    	...
	    	<tr>
				...
				<td><?php echo $this->_tpl_vars['unidad']; ?>
</td>
			</tr>
			<tr>
