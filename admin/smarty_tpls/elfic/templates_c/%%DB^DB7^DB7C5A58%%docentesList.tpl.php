<?php /* Smarty version 2.6.26, created on 2012-06-28 11:10:38
         compiled from usuarios/docentesList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'usuarios/docentesList.tpl', 32, false),array('function', 'cycle', 'usuarios/docentesList.tpl', 52, false),)), $this); ?>
<br />
...
?com=usuarios&do=docentes" method="post" name="adminForm">
    		<tr>
...
" onmouseover="rowOverEffect(this)" 
      ...
      <td onclick="document.location.href='?com=usuarios&do=view_docente&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
...
'"><?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
      ...
      <td onclick="document.location.href='?com=usuarios&do=view_docente&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
'"><?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['docente']; ?>
</td>
      <td onclick="document.location.href='?com=usuarios&do=view_docente&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
'"><?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['institucion']; ?>
</td>
      <td><a href="index2.php?com=usuarios&do=view_docente&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
">Editar</a> | 
