<?php /* Smarty version 2.6.26, created on 2011-05-02 22:56:50
         compiled from comunicados/comunicadosEnviados.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'comunicados/comunicadosEnviados.tpl', 73, false),array('function', 'cycle', 'comunicados/comunicadosEnviados.tpl', 99, false),)), $this); ?>
<br />
      	...
      	<table width="300">
      	    <tr>
      	        <td>
      	            ...
      	            <input name="delenv" type="hidden" id="delenv" value="delenv"/>
...
?com=comunicados" method="post" name="adminForm">
    ...
    <tr>
      ...
      <th class="title"><input type="checkbox" name="chk" onClick="estado()"></th>
...
" 
      ...
      <td onclick="document.location.href='?com=comunicados&do=view&consecu=<?php echo $this->_tpl_vars['com'][$this->_sections['row']['index']]['consecu']; ?>
'"><?php echo $this->_tpl_vars['com'][$this->_sections['row']['index']]['consecu']; ?>
</td>
...
'"><?php echo $this->_tpl_vars['com'][$this->_sections['row']['index']]['fecvence']; ?>
    ...
    <?php endfor; else: ?>
    <tr>
      <td colspan="8">No hay mensajes</td>
    </tr>
    <?php endif; ?>
    </table>
