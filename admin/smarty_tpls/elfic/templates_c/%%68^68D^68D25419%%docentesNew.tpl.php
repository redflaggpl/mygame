<?php /* Smarty version 2.6.26, created on 2012-05-29 16:40:22
         compiled from usuarios/docentesNew.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'usuarios/docentesNew.tpl', 92, false),)), $this); ?>
<?php echo '
      ...
      <table width="100%" class="adminform">
        <tr>
         ...
         <form name="adminForm" id="adminForm" method="post" 
               action="index2.php?com=usuarios&do=nuevo_docente">
