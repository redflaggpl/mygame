<?php /* Smarty version 2.6.26, created on 2012-06-01 17:19:44
         compiled from usuarios/usuariosList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'usuarios/usuariosList.tpl', 50, false),)), $this); ?>
<br />
...
" onmouseover="rowOverEffect(this)" 
      ...
      <td onclick="document.location.href='?com=usuarios&do=view&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
...
'"><?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
      ...
      <td onclick="document.location.href='?com=usuarios&do=view&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
'"><?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['nombres']; ?>
 <?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['apellidos']; ?>
</td>
      <td onclick="document.location.href='?com=usuarios&do=view&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
'"><?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['email']; ?>
</td>
      <td onclick="document.location.href='?com=usuarios&do=view&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
'"><?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['creado']; ?>
</td>
      <td onclick="document.location.href='?com=usuarios&do=view&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
'"><?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['modificado']; ?>
</td>
      <td onclick="document.location.href='?com=usuarios&do=view&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
'"><?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['ultimoingreso']; ?>
</td>
      <td onclick="document.location.href='?com=usuarios&do=view&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
'"><?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['activo']; ?>
</td>
      <td onclick="document.location.href='?com=usuarios&do=view&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
'"><?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['esadmin']; ?>
</td>
      <td ><a href="index2.php?com=usuarios&do=borrar&uid=<?php echo $this->_tpl_vars['u'][$this->_sections['row']['index']]['id']; ?>
" 
