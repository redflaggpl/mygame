<?php /* Smarty version 2.6.26, created on 2012-05-29 17:19:05
         compiled from usuarios/estudiantesEdit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'usuarios/estudiantesEdit.tpl', 92, false),)), $this); ?>
<?php echo '
      ...
      <table width="100%" class="adminform">
        <tr>
         ...
         <form name="adminForm" id="adminForm" method="post" 
               action="index2.php?com=usuarios&do=view_estudiante">
...
" />
	...
	<div class="tab-page" id="pdetails-pane">
	  ...
	  <div class="tab-page" id="desafios-page">
	    ...
	    <p>Máximo desafio alcanzado: <?php echo $this->_tpl_vars['desafio']; ?>
</p>
	    <p>Total de Intentos: <?php echo $this->_tpl_vars['intentos']; ?>
</p>
	  </div>
		   </div><!-- cierre pestañas -->
		</td>
