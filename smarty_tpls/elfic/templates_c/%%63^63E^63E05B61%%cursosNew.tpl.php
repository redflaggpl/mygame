<?php /* Smarty version 2.6.26, created on 2011-05-26 11:58:18
         ...
         <form name="adminForm" id="adminForm" method="post" 
          ...
          <table width="100%" cellspacing="0" cellpadding="0">
            ...
            <td class="headlines">Descripción</td>
             <td><input name="descripcion" type="text" id="descripcion" size="30" 
                  maxlength="45" class="required" value=""/></td>
              <td  class="headlines">Grado</td>
              <td>
                  <select name="grado" id="grado" class="required">
					<option value="">--Seleccione--</option>
		  			<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['grado']), $this);?>
            ...
            <tr>
              ...
              <td>
                  <select name="jornada" id="jornada" class="required">
					<option value="">--Seleccione--</option>
		  			<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['jornada']), $this);?>
              ...
              <td>
                  <select name="id_docente" id="id_docente" class="required">
					<option value="">--Seleccione--</option>
		  			<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['docente']), $this);?>
            ...
            <tr>
              ...
              <td>
                  <select name="sede" id="sede" class="required">
					<option value="">--Seleccione--</option>
		  			<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['sede']), $this);?>
