...
var js_options = {
	...
	useBlur: false, // this will attach an onBlur validator to each form element.
...
var custom_validators = {
	number: {
		...
		defaultMessage: "Valor numerico.",
		regExp: /^[-]?\d+(\.\d+)?$/
	},
	digits: {
		className: "jsvalidate_digits",
		defaultMessage: "Solo n&uacute;meros.",
		regExp: /^[-]?\d+(\.\d+)?$/
	},
	email: {
		className: "jsvalidate_email",
		defaultMessage: "Dirección de email inválida.",
	...
	alpha: {
		...
		defaultMessage: "Este campo debe contener solo letras.",
		regExp: /^[a-zA-z\s]+$/
	},
	alphanum: {
		className: "jsvalidate_alphanum",
		defaultMessage: "Este campo debe contener unicamente letras o números.",
		regExp: /^[a-zA-Z0-9]+$/
	}
};
